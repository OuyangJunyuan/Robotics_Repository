function gst = Stanford_manipulator(l,angle)
q1=[0;0;0];q2=[0;0;l(1)];q3=[0;0;l(1)];q4=[0;l(2)+l(3);l(1)];q5=[0;l(2)+l(3);l(1)];q6=[0;l(2)+l(3)+l(4);l(1)];
